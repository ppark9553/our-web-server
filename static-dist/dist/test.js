...
var _test = __webpack_require__(/*! ./test2.js */ "./js-src/test2.js");
...
var constVar = 'a es6 constant variable';

var printConstVar = function printConstVar() {
  console.log('' + constVar);
};

// TEST 3: can access class from other js files
var testClass = new _test.TestClass();
...
var asyncPrint = function () {
  ...
  return function asyncPrint(_x) {
    return _ref.apply(this, arguments);
  };
}();

var bodyText = document.getElementsByClassName("test-body")[0].innerText;
asyncPrint(bodyText);

// TEST 5: test axios import and API fetching
var testURL = 'http://149.28.25.177/hidden-api/gateway-states/';

var getURL = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(testURL) {
    var getData;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return _axios2.default.get(testURL);
  ...
  return function getURL(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

var handleLogs = function handleLogs(logData) {
  var taskName = logData.task_name;
  var log = logData.log;
  var newListItemHTML = '<strong>' + taskName + '</strong> ' + log;
    ...
    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return getURL(testURL, { crossdomain: true }).then(function (response) {
              var _iteratorNormalCompletion = true;
              var _didIteratorError = false;
              var _iteratorError = undefined;

              try {
                for (var _iterator = (0, _getIterator3.default)(response.data.results), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
/***/ 0:
/*!*********************************************!*\
  !*** multi babel-polyfill ./js-src/test.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! /Users/abc/Desktop/ar_web/js-src/test.js */"./js-src/test.js");
